...
<head>
  <title>Modificar preceptores - ADE</title> <link rel="icon" type="image/png" href="../assets/img/ade-icon.png">
  <!-- Required meta tags -->
  <meta charset="utf-8">
  ...
  <div class="wrapper ">
      ...
      <?php
         ...
         if(isset($_POST["submit"])){
            ...
            $sql = "UPDATE preceptores SET nombre='".$_POST["nombre"]."', apellido='".$_POST["apellido"]."', dni='".$_POST["dni"]."', telefonofijo_p='".$_POST["telfijo"]."', telefonocelular_p='".$_POST["telcelular"]."', mail='".$_POST["correo"]."' WHERE id_preceptor=$id";
