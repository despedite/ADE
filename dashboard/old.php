...
<div class="alert alert-dark" role="alert" style="margin-top: 2vh">
  Estamos trabajando en un nuevo <a href="new.php" class="alert-link">Dashboard</a>. ¡Haz clic en el link para revisarlo, en su forma experimental!
</div>

<div class="card-deck">			
<div class="card">
<div class="card-body">
<h3 class="card-title font-weight-bold">Acceso rápido</h3>
<hr>
<div class="btn-group" role="group" aria-label="Basic example">
<form method="get" action="alumnos/add.php">
<button class="btn btn-rounded peach-gradient btn-sm">Añadir alumno</button>
</form>
<form method="get" action="docentes/add.php">
<button class="btn btn-rounded purple-gradient btn-sm">Añadir docente</button>
</form>
<form method="get" action="preceptores/add.php">
<button class="btn btn-rounded blue-gradient btn-sm">Añadir preceptor</button>
</form>
</div>
</div>
</div>
